...
public interface MemberMapper {
	...
	@Select("SELECT MEMBER_ID memberId , MBTI mbti, MEMBER_JOB job, GENDER gender,  MEMBER_NAME name, NICKNAME nickName, PHONE phone, EMAIL email FROM TB_MEMBER WHERE MEMBER_ID =#{memberId}") 
